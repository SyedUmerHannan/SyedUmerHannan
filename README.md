...
I'm a physician-science student and biotech entrepreneur bridging clinical medicine with cutting-edge wet-lab research. As an MD candidate and CEO of **Virelion Biotech**, I combine expertise in stem cell biology and regenerative medicine with clinical insight to develop therapeutics addressing unmet needs in cardiac disease.
...
*Engineering mature, functional cardiomyocytes for regenerative cardiology.*

Developing clinically relevant iPSC-derived cardiomyocytes through optimized maturation and functional validation.

**Applications:** Post-MI regeneration | Heart failure | Cardiac tissue repair

### [RegenAtlas](https://github.com/SyedUmerHannan/RegenAtlas)

*Investigating mechanisms of cardiac regeneration across species.*

Studying conserved regulatory programs that control cardiomyocyte proliferation to identify pathways with potential for human cardiac regeneration.
...
|-----------|-------------------|
| **Cell Engineering** | iPSC culture, differentiation, maturation, disease modeling |
| **Molecular Biology** | CRISPR/Cas9, cloning, PCR, qPCR, Western blotting |
| **Genomics** | RNA extraction, library prep, RNA-seq, QC |
| **Functional Assays** | Calcium imaging, contractility, electrophysiology, metabolic profiling |
